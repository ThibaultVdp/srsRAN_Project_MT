...
class mac_slice_reconfiguration_procedure
{
public:
  explicit mac_slice_reconfiguration_procedure(du_cell_index_t                    cell_index,
                                            const rrm_policy_ratio_group          reconf,
  ...
  static const char* name() { return "Slice Reconfiguration Request"; }
