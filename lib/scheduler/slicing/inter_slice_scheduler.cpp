...
inter_slice_scheduler::ran_slice_sched_context* inter_slice_scheduler::find_slice(s_nssai_t s_nssai)
{
...
slice_rrm_policy_config* inter_slice_scheduler::find_rrm_policy(s_nssai_t s_nssai)
{
...
std::array<unsigned int, 2> inter_slice_scheduler::generate_slice_prb_bounds(const rrm_policy_ratio_group& rrm_policy)
{
...
bool inter_slice_scheduler::update_slice_config(const rrm_policy_ratio_group reconf)
{
